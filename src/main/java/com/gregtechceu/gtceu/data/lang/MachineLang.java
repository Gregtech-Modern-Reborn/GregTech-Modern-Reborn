...
public class MachineLang {
    ...
    protected static void init(RegistrateLangProvider provider) {
        ...
        for (int tier = 0; tier < 15; tier++) {
            provider.add("gtceu.machine.multi_parallel_hatch_mk" + tier + ".tooltip", "Allows to run up to " +
                    MultiParallelHatchPartMachine.processTierToMaxMultiParallel(tier) + " recipes in multiparallel.");
        }
