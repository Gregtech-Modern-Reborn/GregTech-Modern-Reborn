...
public class IntegrationLang {
    ...
    public static void init(RegistrateLangProvider provider) {
        ...
        initPonderLang(provider);
    }

    private static void initPonderLang(RegistrateLangProvider provider) {
        provider.add("gtceu.ponder.coke_oven.header", "How to Use a Coke Oven");
        provider.add("gtceu.ponder.coke_oven.text_1", "A Coke Oven is a multiblock structure");
        provider.add("gtceu.ponder.coke_oven.text_2", "This is how to build a Coke Oven");
        provider.add("gtceu.ponder.coke_oven.text_3",
                "Once built, right-click the Coke Oven and place the items you want to smelt. The Coke Oven will then begin working");
        provider.add("gtceu.ponder.coke_oven.text_4",
                "While working, the Coke Oven will produce Creosote, which can be used as fuel to smelt 32 items.");
    }
