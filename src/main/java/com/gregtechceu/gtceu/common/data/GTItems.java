...
public class GTItems {
    ...
    public static ItemEntry<ComponentItem> IMAGE_MODULE = REGISTRATE.item("image_module", ComponentItem::create)
            ...
            .register();
    public static ItemEntry<Item> COPPER_CREDIT = REGISTRATE.item("copper_credit", Item::new)
            .lang("Copper Credit")
            .register();
    public static ItemEntry<Item> SILVER_CREDIT = REGISTRATE.item("silver_credit", Item::new)
            .lang("Silver Credit")
            .register();
    public static ItemEntry<Item> GOLD_CREDIT = REGISTRATE.item("gold_credit", Item::new)
            .lang("Gold Credit")
            .register();
    public static ItemEntry<Item> CUPRONICKEL_CREDIT = REGISTRATE.item("cupronickel_credit", Item::new)
            .lang("Cupronickel Credit")
            .register();
    public static ItemEntry<Item> PLATINUM_CREDIT = REGISTRATE.item("platinum_credit", Item::new)
            .lang("Platinum Credit")
            .register();
    public static ItemEntry<Item> OSMIUM_CREDIT = REGISTRATE.item("osmium_credit", Item::new)
            .lang("Osmium Credit")
            .register();
    public static ItemEntry<Item> NAQUADAH_CREDIT = REGISTRATE.item("naquadah_credit", Item::new)
            .lang("Naquadah Credit")
            .register();
    public static ItemEntry<Item> NEUTRONIUM_CREDIT = REGISTRATE.item("neutronium_credit", Item::new)
            .lang("Neutronium Credit")
            .register();
