...
public class FormingPressRecipes {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        GTRecipeTypes.FORMING_PRESS_RECIPES.recipeBuilder(GTCEu.id("calculation_processor_press"))
        ...
        GTRecipeTypes.FORMING_PRESS_RECIPES.recipeBuilder(GTCEu.id("engineering_processor_press"))
        ...
        GTRecipeTypes.FORMING_PRESS_RECIPES.recipeBuilder(GTCEu.id("logic_processor_press"))
        ...
        GTRecipeTypes.FORMING_PRESS_RECIPES.recipeBuilder(GTCEu.id("silicon_processor_press"))
        ...
        GTRecipeTypes.FORMING_PRESS_RECIPES.recipeBuilder(GTCEu.id("printed_calculation_processor"))
                .notConsumable(AEItems.CALCULATION_PROCESSOR_PRESS.asItem())
        ...
        GTRecipeTypes.FORMING_PRESS_RECIPES.recipeBuilder(GTCEu.id("printed_logic_processor"))
                .notConsumable(AEItems.ENGINEERING_PROCESSOR_PRESS.asItem())
        ...
        GTRecipeTypes.FORMING_PRESS_RECIPES.recipeBuilder(GTCEu.id("printed_engineering_processor"))
                .notConsumable(AEItems.ENGINEERING_PROCESSOR_PRESS.asItem())
        ...
        GTRecipeTypes.FORMING_PRESS_RECIPES.recipeBuilder(GTCEu.id("printed_silicon"))
                .notConsumable(AEItems.SILICON_PRESS.asItem())
        ...
        GTRecipeTypes.FORMING_PRESS_RECIPES.recipeBuilder(GTCEu.id("engineering_processor"))
        ...
        GTRecipeTypes.FORMING_PRESS_RECIPES.recipeBuilder(GTCEu.id("calculation_processor"))
        ...
        GTRecipeTypes.FORMING_PRESS_RECIPES.recipeBuilder(GTCEu.id("logic_processor"))
