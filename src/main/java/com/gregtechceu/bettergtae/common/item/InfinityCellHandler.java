package com.gregtechceu.bettergtae.common.item;

import com.gregtechceu.bettergtae.utils.NumberUtil;
    ...
    public void addCellInformationToTooltip(ItemStack stack, List<Component> lines) {
        ...
        if (handler != null && handler.hasDiskUUID()) {
            ...
            lines.add(Component.literal("Byte: ").withStyle(ChatFormatting.GRAY)
                    .append(NumberUtil.numberText(handler.getNbtItemCount()).withStyle(ChatFormatting.GREEN)));
        }
    }
}
