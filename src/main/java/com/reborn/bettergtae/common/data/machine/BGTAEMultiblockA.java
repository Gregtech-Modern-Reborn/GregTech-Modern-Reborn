package com.reborn.bettergtae.common.data.machine;
...
import com.reborn.gtceu.common.machine.multiblock.electric.AssemblyLineMachine;

import net.minecraft.network.chat.Component;

import static com.reborn.gtceu.api.pattern.Predicates.blocks;
import static com.reborn.gtceu.api.pattern.Predicates.dataHatchPredicate;
import static com.reborn.gtceu.api.pattern.util.RelativeDirection.*;
import static com.reborn.gtceu.common.data.GTBlocks.*;
import static com.reborn.gtceu.common.data.GTBlocks.CASING_GRATE;
import static com.reborn.gtceu.common.data.GTRecipeModifiers.OC_NON_PERFECT;
import static com.reborn.gtceu.common.data.GTRecipeModifiers.PARALLEL_HATCH;
...
public class BGTAEMultiblockA {
    ...
    public static final MultiblockMachineDefinition ADVANCED_ASSEMBLY_LINE = REGISTRATE
            ...
            .langValue("Advanced Assembly Line")
            .rotationState(RotationState.ALL)
            .recipeType(GTRecipeTypes.ASSEMBLY_LINE_RECIPES)
            .alwaysTryModifyRecipe(true)
            .recipeModifiers(OC_NON_PERFECT, PARALLEL_HATCH)
            .appearanceBlock(CASING_STEEL_SOLID)
            .tooltips(Component.translatable("gtceu.machine.advanced_assembly_line.0"))
            .tooltips(Component.translatable("gtceu.machine.advanced_assembly_line.1"))
