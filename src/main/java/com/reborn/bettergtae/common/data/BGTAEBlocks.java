package com.reborn.bettergtae.common.data;

import com.reborn.bettergtae.common.block.BGTAECraftingUnitBlock;
import com.reborn.bettergtae.common.block.BGTAECraftingUnitType;
...
public class BGTAEBlocks {
    ...
    private static BlockEntry<BGTAECraftingUnitBlock> registerCraftingUnitBlock(int tier, BGTAECraftingUnitType Type) {
        BlockEntry<BGTAECraftingUnitBlock> Block = REGISTRATE
                ...
                .build()
                .register();
        REGISTRATE.setCreativeTab(Block, GTCreativeModeTabs.MATERIAL_BLOCK);
        return Block;
    }
