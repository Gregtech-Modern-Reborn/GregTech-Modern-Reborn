...
import com.reborn.gtceu.api.gui.fancy.TabsWidget;
import com.reborn.gtceu.api.machine.IMachineBlockEntity;
import com.reborn.gtceu.api.machine.fancyconfigurator.AutoStockingFancyConfigurator;
import com.reborn.gtceu.api.machine.feature.IDataStickInteractable;
import com.reborn.gtceu.api.machine.feature.IHasCircuitSlot;
...
import com.reborn.gtceu.integration.ae2.gui.widget.AEFluidConfigWidget;
import com.reborn.gtceu.integration.ae2.gui.widget.AEItemConfigWidget;
import com.reborn.gtceu.integration.ae2.machine.MEBusPartMachine;
import com.reborn.gtceu.integration.ae2.machine.MEStockingBusPartMachine;
import com.reborn.gtceu.integration.ae2.machine.MEStockingHatchPartMachine;
import com.reborn.gtceu.integration.ae2.machine.feature.multiblock.IMEStockingPart;
import com.reborn.gtceu.integration.ae2.slot.*;
import com.reborn.gtceu.integration.ae2.utils.AEUtil;
        ...
        for (IMultiController controller : getControllers()) {
            for (IMultiPart part : controller.getParts()) {
                if (part instanceof MEDualHatchPartMachine dualPart) {
                    ...
                    if (part instanceof MEStockingHatchPartMachine hatchPart && config.what() instanceof AEFluidKey) {
        ...
        public ItemStack extractItem(int slot, int amount, boolean simulate) {
            if (slot == 0 && this.stock != null) {
                if (this.config != null) {
                    ...
                    MEStorage aeNetwork = Objects.requireNonNull(getMainNode().getGrid()).getStorageService()
                            .getInventory();
