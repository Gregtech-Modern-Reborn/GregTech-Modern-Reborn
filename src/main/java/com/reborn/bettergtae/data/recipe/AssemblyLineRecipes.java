...
import com.reborn.bettergtae.common.data.machine.BGTAEMultiblockA;
...
public class AssemblyLineRecipes {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTCEu.id("extend_me_pattern_buffer"))
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTCEu.id("extend_me_pattern_buffer_proxy"))
        ...
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTCEu.id("me_stocking_dual_input_hatch"))
        ...
        /*
         * GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTCEu.id("1m_computing_core"))
         ...
         * .save(provider);
         * 
         * GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTCEu.id("4m_computing_core"))
         * .inputItems(AEBlocks.CRAFTING_UNIT.asItem())
         ...
         * .save(provider);
         * 
         * GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTCEu.id("16m_computing_core"))
         * .inputItems(AEBlocks.CRAFTING_UNIT.asItem())
         ...
         * .save(provider);
         * 
         * GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTCEu.id("64m_computing_core"))
         * .inputItems(AEBlocks.CRAFTING_UNIT.asItem())
         * .inputItems(AEItems.CELL_COMPONENT_256K.asItem(), 64)
         * .inputItems(AEItems.CELL_COMPONENT_256K.asItem(), 64)
         * .inputItems(AEItems.CELL_COMPONENT_256K.asItem(), 64)
         ...
         * .save(provider);
         * 
         * GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTCEu.id("256m_computing_core"))
         * .inputItems(AEBlocks.CRAFTING_UNIT.asItem())
         ...
         * .save(provider);
         * 
         * GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTCEu.id("max_computing_core"))
         * .inputItems(AEBlocks.CRAFTING_UNIT.asItem())
         ...
         * .save(provider);
         */
        GTRecipeTypes.ASSEMBLY_LINE_RECIPES.recipeBuilder(GTCEu.id("advanced_assembly_line"))
