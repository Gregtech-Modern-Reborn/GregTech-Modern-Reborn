package com.reborn.bettergtae.api.gui;

import com.reborn.gtceu.api.gui.GuiTextures;
import com.reborn.gtceu.api.gui.fancy.IFancyConfigurator;
import com.reborn.gtceu.api.gui.fancy.IFancyCustomMiddleClickAction;
import com.reborn.gtceu.api.gui.fancy.IFancyCustomMouseWheelAction;
...
public class MultiCircuitConfigurator implements IFancyConfigurator, IFancyCustomMouseWheelAction,
        ...
        for (int i = 0; i < slotCount; i++) {
            ...
            if (circuitInventory != null) {
                ...
                middleClickButton.setHoverTooltips(
                        Component.translatable("gtceu.gui.circuit.middle_click_tooltip"));
