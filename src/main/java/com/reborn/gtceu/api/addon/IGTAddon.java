...
import com.reborn.gtceu.api.addon.events.KJSRecipeKeyEvent;
...
import com.reborn.gtceu.common.data.GTOres;
...
public interface IGTAddon {
     ...
     * 
     * @deprecated use {@link com.reborn.gtceu.api.data.chemical.material.event.MaterialRegistryEvent} and
     *             {@link com.reborn.gtceu.api.data.chemical.material.event.MaterialEvent} instead.
     */
    ...
    /**
     * Use {@link com.reborn.gtceu.api.data.worldgen.bedrockore.BedrockOreDefinition#builder(ResourceLocation)} to
     * register the veins.
     */
