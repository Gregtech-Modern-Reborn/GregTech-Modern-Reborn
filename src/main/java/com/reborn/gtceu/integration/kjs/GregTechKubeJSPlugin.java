...
import com.reborn.gtceu.api.cosmetics.CapeRegistry;
import com.reborn.gtceu.api.data.DimensionMarker;
import com.reborn.gtceu.api.data.RotationState;
import com.reborn.gtceu.api.data.chemical.ChemicalHelper;
import com.reborn.gtceu.api.data.chemical.Element;
import com.reborn.gtceu.api.data.chemical.material.ItemMaterialData;
import com.reborn.gtceu.api.data.chemical.material.MarkerMaterial;
import com.reborn.gtceu.api.data.chemical.material.Material;
import com.reborn.gtceu.api.data.chemical.material.info.MaterialFlags;
...
import com.reborn.gtceu.api.data.chemical.material.properties.HazardProperty;
import com.reborn.gtceu.api.data.chemical.material.properties.PropertyKey;
import com.reborn.gtceu.api.data.chemical.material.properties.ToolProperty;
import com.reborn.gtceu.api.data.chemical.material.stack.ItemMaterialInfo;
import com.reborn.gtceu.api.data.chemical.material.stack.MaterialEntry;
import com.reborn.gtceu.api.data.chemical.material.stack.MaterialStack;
import com.reborn.gtceu.api.data.medicalcondition.MedicalCondition;
import com.reborn.gtceu.api.data.medicalcondition.Symptom;
import com.reborn.gtceu.api.data.tag.TagPrefix;
import com.reborn.gtceu.api.data.worldgen.*;
import com.reborn.gtceu.api.data.worldgen.generator.IndicatorGenerator;
import com.reborn.gtceu.api.data.worldgen.generator.VeinGenerator;
import com.reborn.gtceu.api.data.worldgen.generator.indicators.SurfaceIndicatorGenerator.IndicatorPlacement;
import com.reborn.gtceu.api.data.worldgen.generator.veins.DikeVeinGenerator;
import com.reborn.gtceu.api.fluids.FluidBuilder;
import com.reborn.gtceu.api.fluids.FluidState;
import com.reborn.gtceu.api.fluids.attribute.FluidAttributes;
import com.reborn.gtceu.api.fluids.store.FluidStorageKeys;
import com.reborn.gtceu.api.gui.GuiTextures;
import com.reborn.gtceu.api.item.tool.GTToolType;
import com.reborn.gtceu.api.item.tool.ToolHelper;
...
import com.reborn.gtceu.api.machine.multiblock.PartAbility;
import com.reborn.gtceu.api.machine.property.GTMachineModelProperties;
import com.reborn.gtceu.api.pattern.FactoryBlockPattern;
import com.reborn.gtceu.api.pattern.MultiblockShapeInfo;
import com.reborn.gtceu.api.pattern.Predicates;
import com.reborn.gtceu.api.recipe.DummyCraftingContainer;
import com.reborn.gtceu.api.recipe.GTRecipe;
import com.reborn.gtceu.api.recipe.GTRecipeSerializer;
import com.reborn.gtceu.api.recipe.GTRecipeType;
import com.reborn.gtceu.api.recipe.OverclockingLogic;
...
import com.reborn.gtceu.api.recipe.modifier.ModifierFunction;
...
import com.reborn.gtceu.client.renderer.machine.DynamicRenderHelper;
import com.reborn.gtceu.common.cosmetics.GTCapes;
import com.reborn.gtceu.common.data.*;
import com.reborn.gtceu.common.data.machines.GCYMMachines;
import com.reborn.gtceu.common.data.machines.GTMachineUtils;
import com.reborn.gtceu.common.data.machines.GTMultiMachines;
import com.reborn.gtceu.common.data.models.GTMachineModels;
import com.reborn.gtceu.common.data.models.GTModels;
import com.reborn.gtceu.common.item.armor.PowerlessJetpack;
import com.reborn.gtceu.common.machine.multiblock.primitive.PrimitiveFancyUIWorkableMachine;
...
import com.reborn.gtceu.core.mixins.IngredientAccessor;
import com.reborn.gtceu.data.pack.GTDynamicResourcePack;
import com.reborn.gtceu.data.recipe.CraftingComponent;
import com.reborn.gtceu.data.recipe.GTCraftingComponents;
import com.reborn.gtceu.data.recipe.builder.GTRecipeBuilder;
import com.reborn.gtceu.data.recipe.misc.RecyclingRecipes;
import com.reborn.gtceu.integration.kjs.builders.*;
import com.reborn.gtceu.integration.kjs.builders.block.ActiveBlockBuilder;
import com.reborn.gtceu.integration.kjs.builders.block.CoilBlockBuilder;
import com.reborn.gtceu.integration.kjs.builders.machine.*;
import com.reborn.gtceu.integration.kjs.builders.prefix.BasicTagPrefixBuilder;
import com.reborn.gtceu.integration.kjs.builders.prefix.OreTagPrefixBuilder;
import com.reborn.gtceu.integration.kjs.helpers.MachineConstructors;
import com.reborn.gtceu.integration.kjs.helpers.MachineModifiers;
import com.reborn.gtceu.integration.kjs.helpers.MaterialStackWrapper;
import com.reborn.gtceu.integration.kjs.recipe.GTRecipeSchema;
import com.reborn.gtceu.integration.kjs.recipe.GTShapedRecipeSchema;
import com.reborn.gtceu.integration.kjs.recipe.KJSHelpers;
import com.reborn.gtceu.integration.kjs.recipe.WrappingRecipeSchemaType;
import com.reborn.gtceu.integration.kjs.recipe.components.ExtendedOutputItem;
import com.reborn.gtceu.integration.kjs.recipe.components.GTRecipeComponents;
import com.reborn.gtceu.utils.data.RuntimeBlockStateProvider;
...
public class GregTechKubeJSPlugin extends KubeJSPlugin {
    ...
    public void registerClasses(ScriptType type, ClassFilter filter) {
        ...
        filter.allow("com.reborn.gtceu");
        filter.deny("com.reborn.gtceu.core");
        filter.deny("com.reborn.gtceu.common.network");
    }
