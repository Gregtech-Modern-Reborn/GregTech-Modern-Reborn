package com.reborn.gtceu.integration.emi.recipe;
        ...
        for (com.lowdragmc.lowdraglib.gui.widget.Widget w : getFlatWidgetCollection(widget)) {
            if (w instanceof IRecipeIngredientSlot slot) {
                ...
                if (io != null && io != IngredientIO.RENDER_ONLY) {
                    ...
                    if (slot instanceof com.reborn.gtceu.api.gui.widget.SlotWidget slotW) {
                    ...
                    } else if (slot instanceof com.reborn.gtceu.api.gui.widget.TankWidget tankW) {
