package com.reborn.gtceu.data.recipe.serialized.chemistry;
...
import static com.reborn.gtceu.common.data.GTItems.PLANT_BALL;
import static com.reborn.gtceu.common.data.GTItems.STICKY_RESIN;
import static com.reborn.gtceu.common.data.GTMaterials.*;
import static com.reborn.gtceu.common.data.GTRecipeTypes.*;
...
public class SeparationRecipes {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("oilsands_ore_separation")
                ...
                .chancedOutput(new ItemStack(Blocks.SAND), 7500, 500)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("sticky_resin_separation").duration(400).EUt(5)
                ...
                .chancedOutput(PLANT_BALL.asStack(), 1500, 500)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("rubber_log_separation").duration(200).EUt(5)
                ...
                .chancedOutput(STICKY_RESIN.asStack(), 6400, 500)
                .chancedOutput(PLANT_BALL.asStack(), 4000, 500)
                .chancedOutput(dust, Carbon, 3000, 500)
                .chancedOutput(dust, Wood, 3000, 500)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("dirt_separation").duration(250).EUt(VA[LV])
                ...
                .chancedOutput(PLANT_BALL.asStack(), 1400, 500)
                .chancedOutput(new ItemStack(Blocks.SAND), 6000, 500)
                .chancedOutput(dust, Clay, 550, 500)
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("grass_block_separation").duration(250).EUt(VA[LV])
                .inputItems(Blocks.GRASS_BLOCK.asItem())
                .chancedOutput(PLANT_BALL.asStack(), 3500, 500)
                .chancedOutput(new ItemStack(Blocks.SAND), 5500, 500)
                .chancedOutput(dust, Clay, 550, 500)
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("mycelium_separation").duration(650).EUt(VA[LV])
                .inputItems(new ItemStack(Blocks.MYCELIUM))
                .chancedOutput(new ItemStack(Blocks.RED_MUSHROOM), 2800, 500)
                .chancedOutput(new ItemStack(Blocks.BROWN_MUSHROOM), 2800, 500)
                .chancedOutput(new ItemStack(Blocks.SAND), 6200, 500)
                .chancedOutput(dust, Clay, 550, 500)
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("ash_separation").duration(240).EUt(VA[LV])
                .inputItems(dust, Ash)
                .chancedOutput(dust, Quicklime, 4950, 500)
                .chancedOutput(dust, Potash, 1600, 500)
                .chancedOutput(dust, Magnesia, 1500, 500)
                .chancedOutput(dust, PhosphorusPentoxide, 60, 500)
                .chancedOutput(dust, SodaAsh, 600, 500)
                .chancedOutput(dust, Hematite, 275, 500)
                .save(provider);
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("uranium_238_separation").duration(800).EUt(320)
                ...
                .chancedOutput(dustTiny, Plutonium239, 280, 500)
                .chancedOutput(dustTiny, Uranium235, 2300, 500)
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("plutonium_239_separation").duration(1600).EUt(320)
                .inputItems(dust, Plutonium239)
                .chancedOutput(dustTiny, Uranium238, 3400, 500)
                .chancedOutput(dust, Plutonium241, 2500, 500)
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("endstone_separation").duration(320).EUt(20)
                .inputItems(dust, Endstone)
                .chancedOutput(new ItemStack(Blocks.SAND), 9000, 500)
                .chancedOutput(dust, Tungstate, 445, 500)
                .chancedOutput(dust, Platinum, 80, 500)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("netherrack_separation").duration(160).EUt(20)
                ...
                .chancedOutput(dust, Redstone, 700, 500)
                .chancedOutput(dust, Gold, 75, 500)
                .chancedOutput(dust, Sulfur, 2500, 500)
                .chancedOutput(dust, Coal, 700, 500)
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("soul_sand_separation").duration(200).EUt(80)
                .inputItems(Blocks.SOUL_SAND.asItem())
                .chancedOutput(new ItemStack(Blocks.SAND), 9250, 500)
                .chancedOutput(dust, Saltpeter, 2250, 500)
                .chancedOutput(dust, Coal, 225, 500)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("lava_separation").duration(80).EUt(80)
                ...
                .chancedOutput(dust, SiliconDioxide, 1250, 500)
                .chancedOutput(dust, Magnesia, 250, 500)
                .chancedOutput(dust, Quicklime, 250, 500)
                .chancedOutput(nugget, Gold, 250, 500)
                .chancedOutput(dust, Sapphire, 315, 500)
                .chancedOutput(dust, Tantalite, 125, 500)
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("rare_earth_separation").duration(64).EUt(20)
                .inputItems(dust, RareEarth)
                .chancedOutput(dustSmall, Cadmium, 3500, 500)
                .chancedOutput(dustSmall, Neodymium, 4500, 500)
                .chancedOutput(dustSmall, Samarium, 3500, 500)
                .chancedOutput(dustSmall, Cerium, 5500, 500)
                .chancedOutput(dustSmall, Yttrium, 3500, 500)
                .chancedOutput(dustSmall, Lanthanum, 2500, 500)
                .save(provider);
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("red_sand_separation").duration(50).EUt(VA[LV])
                ...
                .chancedOutput(dust, Diamond, 35, 500)
                .chancedOutput(new ItemStack(Blocks.SAND), 8500, 500)
                .save(provider);
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("stone_dust_separation").duration(480).EUt(VA[MV])
                ...
                .chancedOutput(dust, Quartzite, 2500, 500)
                .chancedOutput(dust, PotassiumFeldspar, 2500, 500)
                .chancedOutput(dust, Marble, "2/9", 500)
                .chancedOutput(dust, Biotite, "1/9", 500)
                .chancedOutput(dust, MetalMixture, 925, 500)
                .chancedOutput(dust, Sodalite, 650, 500)
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("metal_mixture_separation").duration(1000).EUt(900)
                .inputItems(dust, MetalMixture)
                .chancedOutput(dust, Hematite, 2500, 500)
                .chancedOutput(dust, Bauxite, 2500, 500)
                .chancedOutput(dust, Pyrolusite, "2/9", 500)
                .chancedOutput(dust, Barite, "1/9", 500)
                .chancedOutput(dust, Chromite, 855, 500)
                .chancedOutput(dust, Ilmenite, 575, 500)
                .save(provider);
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("quartz_sand_separation").duration(60).EUt(VA[LV])
                ...
                .chancedOutput(dust, CertusQuartz, 2500, 500)
                .save(provider);
        ...
        ELECTROLYZER_RECIPES.recipeBuilder("sphalerite_electrolysis")
                ...
                .chancedOutput(dust, Gallium, 750, 500)
        ...
        EXTRACTOR_RECIPES.recipeBuilder("wood_dust_extraction").duration(16).EUt(4)
                ...
                .chancedOutput(PLANT_BALL.asStack(), 225, 500)
