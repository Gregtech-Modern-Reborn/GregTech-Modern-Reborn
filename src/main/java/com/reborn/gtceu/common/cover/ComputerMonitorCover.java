...
import com.reborn.gtceu.client.renderer.cover.CoverTextRenderer;
import com.reborn.gtceu.client.renderer.cover.IDynamicCoverRenderer;
...
public class ComputerMonitorCover extends CoverBehavior
    ...
    public Widget createUIWidget() {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            SlotWidget slot = new com.reborn.gtceu.api.gui.widget.SlotWidget(
                    itemStackHandler,
                    i,
