<p align="center"><img src="https://raw.githubusercontent.com/reborn/Branding/refs/heads/master/gregtech_ceu_modern_logo_large_modern.png" alt="Logo"></p>
...
<h1 align="center">
    <a href="https://www.curseforge.com/minecraft/mc-mods/reborn-modern"><img src="https://img.shields.io/badge/Available%20for-MC%201.20.1+%20-informational?style=for-the-badge" alt="Supported Versions"></a>
    <a href="https://github.com/reborn/GregTech-Modern/blob/1.20.1/LICENSE"><img src="https://img.shields.io/github/license/reborn/GregTech?style=for-the-badge" alt="License"></a>
    ...
    <br>
    <a href="https://www.curseforge.com/minecraft/mc-mods/reborn-modern"><img src="https://cf.way2muchnoise.eu/890405.svg?badge_style=for_the_badge" alt="CurseForge"></a>
    <a href="https://modrinth.com/mod/reborn-modern"><img src="https://img.shields.io/modrinth/dt/reborn-modern?logo=modrinth&label=&suffix=%20&style=for-the-badge&color=2d2d2d&labelColor=5ca424&logoColor=1c1c1c" alt="Modrinth"></a>
    <a href="https://github.com/reborn/GregTech-Modern/releases"><img src="https://img.shields.io/github/downloads/reborn/GregTech-Modern/total?sort=semver&logo=github&label=&style=for-the-badge&color=2d2d2d&labelColor=545454&logoColor=FFFFFF" alt="GitHub"></a>
</h1>

### [Wiki](https://reborn.github.io/GregTech-Modern/)

## Developers

To add GTCEu: Modern Reborn(GTMReborn) to your project as a dependency, add the following to your `build.gradle`:
```groovy
repositories {
    exclusiveContent {
        forRepository {
...
dependencies {
	...
	implementation fg.deobf("curse.maven:gregtech-modern-reborn-1347911:${gtmreborn_fileid}")
