...
Now, they work by AdjacentFluidConditions, added with the `adjacentFluid(Fluid...)` methods. See [our other condition builder methods](https://github.com/reborn/GregTech-Modern/blob/1.20.1/src/main/java/com/reborn/gtceu/integration/kjs/recipe/GTRecipeSchema.java#L894).
