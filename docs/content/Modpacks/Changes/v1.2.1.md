...
For now, please reference the [`BedrockOreDefinition.Builder`](https://github.com/reborn/GregTech-Modern/blob/1.20.1/src/main/java/com/reborn/gtceu/api/data/worldgen/bedrockore/BedrockOreDefinition.java#L117) class in our source code.
