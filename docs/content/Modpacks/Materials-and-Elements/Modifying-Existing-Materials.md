...
```js title="periodic_table_elements.js"
    const $IngotProperty = Java.loadClass('com.reborn.gtceu.api.data.chemical.material.properties.IngotProperty');
    const $DustProperty = Java.loadClass('com.reborn.gtceu.api.data.chemical.material.properties.DustProperty');
    const $BlastProperty = Java.loadClass('com.reborn.gtceu.api.data.chemical.material.properties.BlastProperty');
...
const $FluidProperty = Java.loadClass('com.reborn.gtceu.api.data.chemical.material.properties.FluidProperty');
const $FluidBuilder = Java.loadClass('com.reborn.gtceu.api.fluids.FluidBuilder');
const $FluidStorageKeys = Java.loadClass('com.reborn.gtceu.api.fluids.store.FluidStorageKeys');
...
```js title="ore_property.js"
    ...
    const $OreProperty = Java.loadClass('com.reborn.gtceu.api.data.chemical.material.properties.OreProperty');
...
1. Most methods in the [``Material`` class](https://github.com/reborn/GregTech-Modern/blob/1.20.1/src/main/java/com/reborn/gtceu/api/data/chemical/material/Material.java) can be used in the ``materialModification`` event